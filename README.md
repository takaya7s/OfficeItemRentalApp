...
\bin\Debug\net48\OfficeItemRentalApp.exe を実行します。

Visual Studio で開く場合は、`OfficeItemRentalApp.csproj` を開いてビルド、実行してください。
...
- 後から修正しやすいように、コンソールUI、業務ロジック、データモデル、保存処理を別ファイルに分けました。
